/*
 ...
 Source Server         : MAMP-本地
 Source Server Type    : MySQL
 Source Server Version : 50726
 Source Host           : 127.0.0.1:8889
 Source Schema         : interface_v1_dev

 Target Server Type    : MySQL
 Target Server Version : 50726
 File Encoding         : 65001

 Date: 12/01/2022 11:27:44
*/
...
CREATE TABLE `tb_admin_member` (
  ...
  KEY `username` (`account`,`password`) USING BTREE,
  KEY `organization_id` (`organization_id`) USING BTREE,
  KEY `createtime` (`createtime`) USING BTREE,
  KEY `isdel` (`isdel`) USING BTREE,
  KEY `job_id` (`department_id`,`department_job_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='后台管理员';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci ROW_FORMAT=DYNAMIC COMMENT='验证码';
...
CREATE TABLE `tb_department_job` (
  ...
  KEY `isdel` (`isdel`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='部门职位';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='接口访问日志';
...
CREATE TABLE `tb_operating_log` (
  ...
  KEY `type` (`type`) USING BTREE,
  KEY `org_id` (`org_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='操作记录';
...
CREATE TABLE `tb_operating_log_detail` (
  ...
  KEY `createtime` (`createtime`) USING BTREE,
  KEY `edittime` (`edittime`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='操作详情';
...
CREATE TABLE `tb_partner_member` (
  ...
  KEY `isdel` (`isdel`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='合伙人';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='合伙人商务负责人关联';
...
CREATE TABLE `tb_partner_verify` (
  ...
  KEY `edittime` (`edittime`) USING BTREE,
  KEY `member_id` (`member_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='合伙人认证';
...
CREATE TABLE `tb_region` (
  `tbid` int(10) unsigned NOT NULL AUTO_INCREMENT COMMENT '区域编号',
  `name` varchar(60) DEFAULT NULL COMMENT '区域名称',
  `statis_code` varchar(12) DEFAULT NULL COMMENT '区域国标编码',
  `code` varchar(6) DEFAULT NULL COMMENT '区域编码',
  `full_name` varchar(400) DEFAULT NULL COMMENT '区域全称',
  `region_type` tinyint(4) DEFAULT NULL COMMENT '类型',
  `sort` tinyint(4) DEFAULT '0' COMMENT '排列顺序',
  `parent_id` int(11) DEFAULT NULL COMMENT '上级对象编号',
  `isdel` tinyint(4) DEFAULT '0' COMMENT '是否删除',
  `lat` float DEFAULT NULL COMMENT '维度',
  `lng` float DEFAULT NULL COMMENT '经度',
  PRIMARY KEY (`tbid`) USING BTREE,
  KEY `idx_parentID` (`region_type`,`parent_id`),
  KEY `idx_code` (`code`)
) ENGINE=InnoDB AUTO_INCREMENT=44977 DEFAULT CHARSET=utf8 COMMENT='国家4级地址地区';
...
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='供应商表';
...
CREATE TABLE `tb_supply_member` (
  ...
  KEY `organization_id` (`org_id`) USING BTREE,
  KEY `isdel` (`isdel`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='供应商员工表';
...
CREATE TABLE `tb_supply_verify` (
  ...
  KEY `edittime` (`edittime`) USING BTREE,
  KEY `member_id` (`member_id`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='供应商认证';
...
CREATE TABLE `tb_upload_log` (
  ...
  KEY `member_id` (`member_id`) USING BTREE,
  KEY `type` (`type`) USING BTREE
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 ROW_FORMAT=DYNAMIC COMMENT='上传日志';
